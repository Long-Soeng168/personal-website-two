...
export function CardPattern({ mouseX, mouseY, randomString }) {
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 transition duration-500 opacity-0 bg-gradient-to-r from-green-500 to-blue-700 group-hover/card:opacity-100 backdrop-blur-xl"
        style={style}
      />
      <motion.div
