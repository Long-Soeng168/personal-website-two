...
export function MyServiceFeatures() {
  return (
    <div className="px-4 md:px-8 lg:px-10">
      ...
      <ul className="grid grid-cols-1 my-10 grid-rows-none gap-4 md:grid-cols-12 md:grid-rows-3 lg:gap-4 xl:max-h-[34rem] xl:grid-rows-2">
        <GridItem
          area="md:[grid-area:1/1/2/7] xl:[grid-area:1/1/2/5]"
          icon={<Box className="w-4 h-4 text-black dark:text-neutral-400" />}
        ...
        <GridItem
          ...
          icon={
            <Settings className="w-4 h-4 text-black dark:text-neutral-400" />
          }
        ...
        <GridItem
          ...
          icon={
            <Sparkles className="w-4 h-4 text-black dark:text-neutral-400" />
          }
        ...
        <GridItem
          ...
          icon={<Search className="w-4 h-4 text-black dark:text-neutral-400" />}
